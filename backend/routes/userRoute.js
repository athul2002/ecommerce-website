...
const { registerUser, loginUser, logout, forgotPassword, resetPassword, detailUser, updatePassword, updateUserDetail, getAllUsers, getUser, updateUserRole, deleteUser } = require('../controllers/userController');
