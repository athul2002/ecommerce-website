...
const { getAllProducts, createProduct, updateProducts, deleteProduct, detailProduct, giveProductReview, getProductReviews, deleteReviews, getAdminProducts } = require('../controllers/productController');
